...
$text['Indice'] = 'Index';
$text['300'] = 'What is it?';
$text['301'] = 'It´s a project which aim to apply TIC´s in an area of opotunity as the air pollutants, and the consumption of electric energy, in order to help the citizens to enjoy the information in order to make decisions. This is the beginning of a smart city.';
...
$text['1'] = 'Why was the project done?';
$text['2'] = 'In recent years,the grown up of industrial process in which combustion of hydrocarbons are involved, besides the excessive purchase of automobiles (due to the ease of financing the purchase of this one), it has caused that air pollution increases considerably affecting the health and rhythm of daily activities of citizens. Because of that, it is necessary to provide the user with information that is useful environment where their moves to take your care and cautions.';
$text['3'] = 'PROJECT´s OBJECTIVE';
$text['4'] = 'Development of a prototype monitoring of air pollutants in the air and energy consumption of efficiency on infrastructure in the air and energy consumption of efficiency on infrastructure public lightning in the City of Mexico.';   
$text['5'] = 'LOGO´s MEANING'; 
$text['6'] = 'The logo is a pictogram Nahuatl means nose, like the name. This is to represent the purpose of the module that is the detection of atmospheric pollutants to "sniff" or caught data with sensors. Why did we decide to use the Nahuatl language?: Being a device and project developed in Mexico, it was decided to take part our roots, taking the name in Náhualt.';
...
$text['131'] = "There are 2 Prototype Modules: Outer and Inner";
...
$text['378'] = "A quantity (CO2 < 1000 ppm ) is considered as acceptable standards for student achievement.";
$text['379'] = "While an amount ( CO2 > 1000 ppm ) are due to 10% to 20 % student absence.";
$text['380'] = "You can work an 8 hours a day as long as less than 5000 ppm are.";
$text['381'] = "If exceeds 30000 is recommended not remain in that environment more than 10 minutes.";
$text['382'] = "The levels normal from O3 within a school it is less than one (de 0.13 a 0.8).";
$text['383'] = "The levels from O3 higher they are in schools located near areas affected by industrial or urban pollution.";
$text['384'] = "Contamination O3 most of the time comes outside, in fact there is a direct correlation increased rapidly when the doors or windows are open.";
$text['385'] = "The indoor air quality.";
$text['386'] = "The indoor air quality it is a very important factor to consider for student achievement. Indoor pollution they can lead to health problems as well as, cognitive problems.";
$text['387'] = "Reference Stafford, T. M. (2015). Indoor air quality and academic performance. Journal of Environmental Economics and Management, 70, 34–50. doi:10.1016/j.jeem.2014.11.002.";
$text['388'] = "The most common gases air found within the school sound: CO, SO2 y NO2. The Nitrogen oxides (NOx both sum monóxido de nitrógeno (NO) as dióxido (NO2)) comes mainly from outside, from vehicular traffic, but many studies reveal that the most important factors that increase exposure NOx, on the position of the buildings in the city, is the use of gas for heating applications. Exposure to high concentrations from NO2 it represents a risk factor modest for respiratory diseases.";
$text['389'] = "The óxidos de nitrógeno enter by emissions smoke from nearby traffic vehicles, an estimated emission rates (entrance  / exit) )from the  NO2  van from the  0.88 a 1.";
...
$text['391'] = "One of the most common problems having polluted air are respiratory problems, which cause most absences, in fact, recent studies show that approximately 3.4 % classrooms with air above the standard  stipulated can reduce student attendance respiratory diseases product.";
    ?>